<template>
  <div class="user">
    ...
    <van-cell-group>
      ...
      <!-- 列表区域 -->
      <van-cell title="分销中心" icon="user-o" value="收益200元" is-link></van-cell>
      ...
      <van-cell title="关于拉钩教育" icon="info-o" value="v2.0.0" is-link></van-cell>
    </van-cell-group>
...
<script>
import { cell, cellGroup, grid, gridItem, image, icon } from 'vant'
